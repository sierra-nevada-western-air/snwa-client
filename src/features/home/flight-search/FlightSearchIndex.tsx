...
const FlightSearchIndex: React.FC = () => {
	const airports: Array<string> = ['Ontario - ONT', 'Las Vegas - LAS', 'Reno - RNO', 'Colorado Springs - COS', 'Kansas City - MCI', 'Memphis- MEM'];
						...
						<InputField>
							<InputControl>
								<label className="radio">
									<input type="radio" name="roundTripRadio" onClick={toggleRoundTrip} defaultChecked />
									Round Trip
								</label>
								<label className="radio">
				...
				<Columns>
					<Column>
						<InputField>
							...
							<InputControl>
								<input type="date" className="input" id="departureInput" min={new Date().toISOString().split('T')[0]} />
							</InputControl>
						</InputField>
					</Column>
					<Column>
